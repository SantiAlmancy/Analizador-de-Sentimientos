...
from .views import HotelListView, HotelReviewListView, CreateReviewView, CreateHotelView, TextClassificationView
...
urlpatterns = [
    ...
    path('classify-text/', TextClassificationView.as_view(), name='classify-text'),
]
